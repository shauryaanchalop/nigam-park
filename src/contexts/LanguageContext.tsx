...
const translations: Translations = {
  ...
  'business.formDescription': { en: 'Fill in your details and our officials will contact you within 24 hours', hi: 'अपनी जानकारी भरें और हमारी टीम 24 घंटे में संपर्क करेगी' },
  ...
  'business.thankYou': { en: 'Thank you! Our officials will contact you shortly.', hi: 'धन्यवाद! हमारी टीम जल्द ही संपर्क करेगी।' },
  ...
  // Form Validation
  'validation.required': { en: 'This field is required', hi: 'यह फ़ील्ड आवश्यक है' },
  'validation.invalidEmail': { en: 'Please enter a valid email address', hi: 'कृपया वैध ईमेल पता दर्ज करें' },
  'validation.invalidPhone': { en: 'Please enter a valid phone number', hi: 'कृपया वैध फोन नंबर दर्ज करें' },
  'validation.invalidVehicle': { en: 'Please enter a valid vehicle number', hi: 'कृपया वैध वाहन नंबर दर्ज करें' },
  'validation.minLength': { en: 'Must be at least {min} characters', hi: 'कम से कम {min} अक्षर होने चाहिए' },
  'validation.maxLength': { en: 'Must be less than {max} characters', hi: '{max} अक्षरों से कम होना चाहिए' },
  'validation.passwordMismatch': { en: 'Passwords do not match', hi: 'पासवर्ड मेल नहीं खाते' },
  'validation.weakPassword': { en: 'Password must be at least 8 characters with numbers and letters', hi: 'पासवर्ड कम से कम 8 अक्षर का होना चाहिए जिसमें अंक और अक्षर हों' },
  'validation.invalidAmount': { en: 'Please enter a valid amount', hi: 'कृपया वैध राशि दर्ज करें' },
  'validation.invalidDate': { en: 'Please enter a valid date', hi: 'कृपया वैध तारीख दर्ज करें' },
  'validation.futureDate': { en: 'Date must be in the future', hi: 'तारीख भविष्य में होनी चाहिए' },
  'validation.pastDate': { en: 'Date must be in the past', hi: 'तारीख अतीत में होनी चाहिए' },
  'validation.invalidTime': { en: 'Please enter a valid time', hi: 'कृपया वैध समय दर्ज करें' },
  'validation.selectOption': { en: 'Please select an option', hi: 'कृपया एक विकल्प चुनें' },
  'validation.invalidFile': { en: 'Invalid file type', hi: 'अमान्य फ़ाइल प्रकार' },
  'validation.fileTooLarge': { en: 'File size must be less than {size}MB', hi: 'फ़ाइल का आकार {size}MB से कम होना चाहिए' },
  'validation.invalidUrl': { en: 'Please enter a valid URL', hi: 'कृपया वैध URL दर्ज करें' },
  'validation.numbersOnly': { en: 'Only numbers are allowed', hi: 'केवल अंकों की अनुमति है' },
  'validation.lettersOnly': { en: 'Only letters are allowed', hi: 'केवल अक्षरों की अनुमति है' },
  'validation.alphanumeric': { en: 'Only letters and numbers are allowed', hi: 'केवल अक्षर और अंकों की अनुमति है' },
  'validation.positiveNumber': { en: 'Must be a positive number', hi: 'सकारात्मक संख्या होनी चाहिए' },
  'validation.minValue': { en: 'Must be at least {min}', hi: 'कम से कम {min} होना चाहिए' },
  'validation.maxValue': { en: 'Must be at most {max}', hi: 'अधिकतम {max} होना चाहिए' },

  // Toast Notifications
  'toast.success': { en: 'Success', hi: 'सफल' },
  'toast.error': { en: 'Error', hi: 'त्रुटि' },
  'toast.warning': { en: 'Warning', hi: 'चेतावनी' },
  'toast.info': { en: 'Information', hi: 'जानकारी' },
  'toast.loading': { en: 'Loading...', hi: 'लोड हो रहा है...' },
  'toast.saved': { en: 'Changes saved successfully', hi: 'परिवर्तन सफलतापूर्वक सहेजे गए' },
  'toast.deleted': { en: 'Deleted successfully', hi: 'सफलतापूर्वक हटाया गया' },
  'toast.updated': { en: 'Updated successfully', hi: 'सफलतापूर्वक अपडेट किया गया' },
  'toast.created': { en: 'Created successfully', hi: 'सफलतापूर्वक बनाया गया' },
  'toast.copied': { en: 'Copied to clipboard', hi: 'क्लिपबोर्ड पर कॉपी किया गया' },
  'toast.uploadSuccess': { en: 'File uploaded successfully', hi: 'फ़ाइल सफलतापूर्वक अपलोड हुई' },
  'toast.uploadFailed': { en: 'Failed to upload file', hi: 'फ़ाइल अपलोड करने में विफल' },
  'toast.networkError': { en: 'Network error. Please check your connection', hi: 'नेटवर्क त्रुटि। कृपया अपना कनेक्शन जांचें' },
  'toast.serverError': { en: 'Server error. Please try again later', hi: 'सर्वर त्रुटि। कृपया बाद में पुनः प्रयास करें' },
  'toast.sessionExpired': { en: 'Session expired. Please login again', hi: 'सत्र समाप्त। कृपया पुनः लॉगिन करें' },
  'toast.unauthorized': { en: 'You are not authorized to perform this action', hi: 'आप इस कार्रवाई के लिए अधिकृत नहीं हैं' },
  'toast.notFound': { en: 'Resource not found', hi: 'संसाधन नहीं मिला' },
  'toast.invalidInput': { en: 'Please check your input and try again', hi: 'कृपया अपना इनपुट जांचें और पुनः प्रयास करें' },
  'toast.loginSuccess': { en: 'Logged in successfully', hi: 'सफलतापूर्वक लॉगिन हुआ' },
  'toast.logoutSuccess': { en: 'Logged out successfully', hi: 'सफलतापूर्वक लॉगआउट हुआ' },
  'toast.signupSuccess': { en: 'Account created successfully', hi: 'खाता सफलतापूर्वक बनाया गया' },
  'toast.passwordReset': { en: 'Password reset email sent', hi: 'पासवर्ड रीसेट ईमेल भेजा गया' },
  'toast.passwordChanged': { en: 'Password changed successfully', hi: 'पासवर्ड सफलतापूर्वक बदला गया' },
  'toast.profileUpdated': { en: 'Profile updated successfully', hi: 'प्रोफाइल सफलतापूर्वक अपडेट हुई' },
  'toast.reservationCreated': { en: 'Reservation created successfully', hi: 'बुकिंग सफलतापूर्वक बनाई गई' },
  'toast.reservationCancelled': { en: 'Reservation cancelled', hi: 'बुकिंग रद्द की गई' },
  'toast.checkInSuccess': { en: 'Check-in successful', hi: 'चेक-इन सफल' },
  'toast.checkOutSuccess': { en: 'Check-out successful', hi: 'चेक-आउट सफल' },
  'toast.paymentSuccess': { en: 'Payment successful', hi: 'भुगतान सफल' },
  'toast.paymentFailed': { en: 'Payment failed. Please try again', hi: 'भुगतान विफल। कृपया पुनः प्रयास करें' },
  'toast.reportSubmitted': { en: 'Report submitted successfully', hi: 'रिपोर्ट सफलतापूर्वक जमा हुई' },
  'toast.reviewSubmitted': { en: 'Review submitted successfully', hi: 'समीक्षा सफलतापूर्वक जमा हुई' },
  'toast.alertEnabled': { en: 'Alert enabled', hi: 'अलर्ट सक्षम' },
  'toast.alertDisabled': { en: 'Alert disabled', hi: 'अलर्ट अक्षम' },
  'toast.broadcastSent': { en: 'Broadcast sent successfully', hi: 'प्रसारण सफलतापूर्वक भेजा गया' },
  'toast.targetSet': { en: 'Target set successfully', hi: 'लक्ष्य सफलतापूर्वक निर्धारित' },
  'toast.shiftAssigned': { en: 'Shift assigned successfully', hi: 'शिफ्ट सफलतापूर्वक असाइन की गई' },
  'toast.vehicleAdded': { en: 'Vehicle added successfully', hi: 'वाहन सफलतापूर्वक जोड़ा गया' },
  'toast.vehicleRemoved': { en: 'Vehicle removed successfully', hi: 'वाहन सफलतापूर्वक हटाया गया' },
  'toast.fineResolved': { en: 'Fine resolved successfully', hi: 'जुर्माना सफलतापूर्वक हल हुआ' },
  'toast.fineWaived': { en: 'Fine waived successfully', hi: 'जुर्माना सफलतापूर्वक माफ़ हुआ' },
  'toast.statusUpdated': { en: 'Status updated successfully', hi: 'स्थिति सफलतापूर्वक अपडेट हुई' },
  'toast.settingsSaved': { en: 'Settings saved successfully', hi: 'सेटिंग्स सफलतापूर्वक सहेजी गईं' },
  'toast.passActivated': { en: 'Monthly pass activated', hi: 'मासिक पास सक्रिय हुआ' },
  'toast.referralCopied': { en: 'Referral code copied', hi: 'रेफरल कोड कॉपी किया गया' },
  'toast.pointsEarned': { en: 'Points earned!', hi: 'पॉइंट्स मिले!' },
  'toast.pointsRedeemed': { en: 'Points redeemed successfully', hi: 'पॉइंट्स सफलतापूर्वक उपयोग हुए' },
};
